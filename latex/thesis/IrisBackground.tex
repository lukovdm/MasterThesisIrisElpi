...
\end{itemize}
\quest{Should I include ghost states etc. in this grammer? We won't be using them but they are part of Iris.}
\section{Proof rules}
\begin{itemize}
...
\begin{itemize}
  \item Write something about fixpoints, ind, iter and others
\end{itemize}
